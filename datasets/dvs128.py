...
import datasets.neuromorphicDatasets as sjds
...
class DVS128Gesture(sjds.NeuromorphicDatasetFolder):
    def __init__(
        ...
        super().__init__(root, train, data_type, frames_number, split_by, duration, custom_integrate_function,
                         custom_integrated_frames_dir_name, transform, target_transform, overlap)
    ...
    def create_events_np_files(extract_root: str, events_np_root: str):
        ...
        with open(os.path.join(aedat_dir, 'trials_to_train.txt')) as trials_to_train_txt, open(
            ...
            with ThreadPoolExecutor(
                    max_workers=min(multiprocessing.cpu_count(), max_threads_number_for_datasets_preprocess)) as tpe:
                ...
                for fname in trials_to_train_txt.readlines():
                    ...
                    if fname.__len__() > 0:
                        ...
                        tpe.submit(DVS128Gesture.split_aedat_files_to_np, fname, aedat_file,
                                   os.path.join(aedat_dir, fname + '_labels.csv'), train_dir)
